...
import { getBusinessesByCategory, getBusinessesByCity, getBusinessesByCityAndCategory } from '@/lib/seniors/getBusinesses'
    ...
    <div className="directory-page">
      ...
      <div className="listing-grid">
        {businesses.map((b: any) => (
          <div key={b.slug} className="listing-card">
            <h3><Link href={`/seniors/directory/${b.slug}`}>{b.name}</Link></h3>
            <p>{b.description}</p>
          </div>
        ))}
      </div>
          ...
          <div key={catSlug} className="category-row">
            ...
            <div className="row-grid">
              {catBusinesses.slice(0, 4).map((b: any) => (
                <div key={b.slug} className="business-card">
                  <h3><Link href={`/seniors/directory/${b.slug}`}>{b.name}</Link></h3>
                  <p>{b.description}</p>
                </div>
              ))}
