    ...
    <div className="space-y-6 p-6 max-w-4xl mx-auto">
      ...
      {location?.error && (
        <div className="p-4 bg-red-100 border border-red-400 rounded-lg">
          ...
          {location.details && <p className="text-sm text-red-600">{location.details}</p>}
        </div>
      )}
      ...
      <div className="p-6 bg-white rounded-lg shadow-md">
        ...
        <div className="space-y-2">
          <p>
            <strong>IP Address:</strong> <code className="bg-gray-100 px-2 py-1 rounded">{location?.ip || 'N/A'}</code>
          </p>
          <p>
          ...
          <p>
            <strong>Timezone:</strong> {location?.timezone || 'Unknown'}
          </p>
          {location?.isp && (
            <p>
      ...
      <div className="p-6 bg-blue-50 rounded-lg border border-blue-200">
          ...
          <div className="mt-4 p-4 bg-white rounded-lg border border-gray-200">
            {testResult.error ? (
              ...
              <div className="space-y-2">
                ...
                <p>
                  <strong>Country:</strong> {testResult.country} ({testResult.countryCode})
                </p>
                <p>
        ...
        {rawAPIResponse && (
          <details className="mt-4">
            <summary className="cursor-pointer font-semibold text-blue-700">View Raw API Response</summary>
      ...
      {debugInfo && (
        <div className="p-6 bg-gray-100 rounded-lg">
          ...
          <p className="mb-2">
            <strong>Detected IP from Server:</strong> <code className="bg-gray-200 px-2 py-1 rounded">{debugInfo.ip}</code>
          </p>
          <p className="mb-2 text-sm text-gray-600">
            <strong>Timestamp:</strong> {debugInfo.timestamp}
          </p>
          <details className="mt-4">
            <summary className="cursor-pointer font-semibold">Headers Received by Server</summary>
      ...
      <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg text-sm text-gray-700">
        ...
        <ul className="mt-2 list-disc list-inside space-y-1">
          <li>On localhost, your IP appears as "unknown" because there's no real IP header</li>
          <li>Try testing with these public IPs: <code className="bg-yellow-100 px-1">1.1.1.1</code> (Cloudflare), <code className="bg-yellow-100 px-1">8.8.8.8</code> (Google), <code className="bg-yellow-100 px-1">13.107.42.14</code> (Microsoft)</li>
          <li>When deployed to production, you'll get the real user's location automatically</li>
